...
const CountdownComponent = () => {
    ...
    let interval = useRef();
    let intervalCurrent = interval.current;
    const startTimer = () =>{
   ...
   useEffect(()=>{
    ...
    return (
        <>
            <Box mt={3}>
                <Grid container spacing={{xs:1 , md:3}} px={{sm:1,md:3}}>
                    <Grid item xs={3}>
                        <Card sx={{py:{xs:1,sm:2} , borderRadius:'10px' , boxShadow:'none' , border:'1px solid #003049' , backgroundColor:'#e7ebee' }} >
